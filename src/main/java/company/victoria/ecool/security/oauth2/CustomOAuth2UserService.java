package company.victoria.ecool.security.oauth2;

import company.victoria.ecool.exception.OAuth2AuthenticationProcessingException;
...
import company.victoria.ecool.security.oauth2.user.OAuth2UserInfo;
import company.victoria.ecool.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        if(oAuth2UserInfo.getName() != null) user.setName(oAuth2UserInfo.getName()); else user.setName(oAuth2UserInfo.getEmail());
